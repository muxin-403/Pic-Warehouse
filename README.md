...
<p align="center">
  <a href="https://muxin-403.github.io/Pic-Warehouse/">文档</a> ·
  <a href="#界面预览">预览</a> ·
  <a href="#特性">特性</a> ·
  <a href="#技术栈">技术栈</a> ·
  <a href="#快速开始">快速开始</a> ·
...
- **多后端存储**：本地磁盘 + S3 兼容（R2 / COS / OSS / AWS）+ WebDAV（Nextcloud / 坚果云 / Alist 等）；混合直链 `proxy` / `public`
...
| 存储 | 本地磁盘 · S3 兼容（[AWS SDK](https://aws.amazon.com/sdk-for-javascript/) · R2 / COS / OSS 等） · WebDAV |
...
**详细说明**（环境变量、双域名、API、Twikoo、反向代理、本地开发等）见 **[用户文档](https://muxin-403.github.io/Pic-Warehouse/)**。

| 分支 | 说明 |
| ---- | ---- |
| [**main**](https://github.com/muxin-403/Pic-Warehouse/tree/main) | 默认主线：多后端、双域名、统一 `images/` 存储 |
